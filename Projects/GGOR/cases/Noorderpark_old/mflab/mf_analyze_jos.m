...
[GLGn,GVGn,GHGn] = getGXG_oud(hNumeric ,tne(:,1),0); % numerical
[GLGa,GVGa,GHGa] = getGXG_oud(hAnalytic,tne(:,1),0); % analytic
...
% plot(ax,1:Nsec,GLGn,'ro-','markerFaceColor','r');
% plot(ax,1:Nsec,GVGn,'go-','markerFaceColor','g');
% plot(ax,1:Nsec,GHGn,'bo-','markerFaceColor','b');
...
%%
figure('position',screenPos(0.8, 0.5));
